...
// Begin Main Program
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void PyInit_MD(real deltaT2, real density2, int initUcellx2, int initUcelly2,
        int stepAvg2, int stepEquil2, int stepLimit2, real temperature2,
        int limitVel2, real rangeVel2, int sizeHistVel2, int stepVel2,
        int randSeedP2, int printout2){
    deltaT = deltaT2;
    density = density2;
    initUcell.x = initUcellx2;
    initUcell.y = initUcelly2;
    stepAvg = stepAvg2;
    stepEquil = stepEquil2;
    stepLimit = stepLimit2;
    temperature = temperature2;
    limitVel = limitVel2;
    rangeVel = rangeVel2;
    sizeHistVel = sizeHistVel2;
    stepVel = stepVel2;
    randSeedP = randSeedP2;
    printout = printout2;
...
void PrintSummary (){
    ...
    PropEst (kinEnergy), PropEst (pressure), uSum);}
